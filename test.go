...
func loadConfig(path string,host_ip string) (c *Config) {
...
func main() {
	...
	cli.StringFlag{
	Name:        "server, s",
	Usage:       "server ip address (Optional)",
	Value:       "",
	Destination: &server,
	},
	}
